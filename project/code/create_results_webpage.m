...
fprintf(     'Accuracy (mean of diagonal of confusion matrix) is %.4f\n', accuracy);
...
fileID = fopen('results_webpage/accuracy.txt','w');
fprintf(fileID,'%.4f', accuracy);
fclose(fileID);
...
fprintf(fid,'<center>\n');
fprintf(fid,'<h1>CS 5335 Project Results visualization</h1>\n');
fprintf(fid,'<img src="confusion_matrix.png">\n\n');
fprintf(fid,'<br>\n');
fprintf(fid,'Accuracy (mean of diagonal of confusion matrix) is %.4f\n', accuracy);
fprintf(fid,'<p>\n\n');
